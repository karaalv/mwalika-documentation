...
This repository is used for maintaining all **documentation, research materials, and pitch resources** for the Mwalika project.

Mwalika is an agentic AI system designed to support citizens in navigating government digital services, with an initial focus on the Kenyan eCitizen platform. This work forms part of a formal **proposal submitted to a national government hackathon organised by the National Intelligence and Research University (NIRU)**.

This repository acts as the central source of truth for non-code artefacts that support the design, justification, and communication of the project.
...
This repository is **documentation-only**. Source code, services, and infrastructure are maintained in separate repositories to support a modular, service-oriented architecture.
...
This repository is under active development and will evolve as the Mwalika project progresses.
